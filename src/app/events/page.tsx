    ...
    return (<div>
        <div className="grid grid-cols-12 grid-rows-12 w-full h-[45em] overflow-y-hidden">
            ...
            <a href="#upcoming" className="hover:underline group col-start-5 row-start-6 col-span-full items-center flex flex-row justify-left z-10">
                <h3 className="lexend text-5xl group-hover:translate-x-1">
                    Upcoming Events
                </h3>
                <Image src={ArrowRight} className=" group-hover:translate-x-1 -translate-x-1 w-10 h-10 inline ml-2" alt="Arrow pointing right" />
            </a>
            ...
            <Image src={bottleCapMural} className="row-start-1 row-span-full object-cover h-full w-auto lg:w-full lg:h-auto col-start-3 col-span-full -z-1 opacity-90" alt="The bottle cap mural made in 2016 at stuy that tells students to reduce, reuse, and recycle" />
        </div>
        ...
        <div className="w-full h-[55em] grid grid-cols-12 grid-rows-12 ">
            ...
            <Image src={onTheWall} className="col-start-6 row-start-3 overflow-hidden p-3 col-span-full row-end-11 object-cover w-full h-auto" alt="The school board that SEC uses, which displays a chinese lunar new year thing in this image along with some other stuff" />
        </div>
