            ...
            >
                ...
                <div className="min-w-full h-full bg-gray-50">
                    <div className="text-center h-full w-full grid grid-cols-12 grid-rows-12">
                        <h2 className="z-1 bg-opacity-50 col-start-2 row-start-1 sm:row-start-2 text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-bold mb-4 text-left whitespace-break-spaces md:whitespace-nowrap" style={{ textShadow: "2px 2px 4px rgba(0,0,0,0.1)" }}>
                            The Stuyvesant <br />
