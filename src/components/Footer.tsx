...
export default function Footer() {
    ...
    return (<div className="w-full h-80 grid grid-cols-12 grid-rows-12">
        <div className="flex justify-between col-start-2 sm:col-start-4 md:col-start-4 lg:col-start-5 col-end-12 sm:col-end-10 md:col-end-10 lg:col-end-9 row-start-1 row-span-2 m-2">
            <a href="https://epsilon.stuysu.org/SEC"><Image className="transform transition duration-500 ease-in-out hover:scale-110 hover:-translate-y-2 hover:rotate-3 w-10 h-auto motion-reduce:transition-none motion-reduce:hover:transform-none" src={su_logo} alt="SU Logo and Link to the SU website" /></a>
            <a href="https://discord.gg/N8GUFcAZPJ"><Image className="transform transition duration-500 ease-in-out hover:scale-110 hover:-translate-y-2 hover:rotate-3 w-10 h-auto motion-reduce:transition-none motion-reduce:hover:transform-none" src={discord_logo} alt="Discord Logo and Link to the SEC discord page" /></a>
            <a href="https://www.instagram.com/stuyenviroclub"><Image className="transform transition duration-500 ease-in-out hover:scale-110 hover:-translate-y-2 hover:rotate-3 w-10 h-auto motion-reduce:transition-none motion-reduce:hover:transform-none" src={instagram_logo} alt="Instagram Logo and Link to the SEC insta page" /></a>
            <a href="https://www.facebook.com/groups/281609128612255"><Image className="transform transition duration-500 ease-in-out hover:scale-110 hover:-translate-y-2 hover:rotate-3 w-10 h-auto motion-reduce:transition-none motion-reduce:hover:transform-none" src={facebook_logo} alt="Facebook Logo and Link to the SEC facebook page" /></a>
        </div>
